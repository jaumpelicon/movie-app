...
class RatedMovieAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return MovieViewHolder(
            LayoutInflater.from(parent.context)
                .inflate(R.layout.recycler_view_movie_rated, parent, false),
        )
    }
    ...
    class MovieViewHolder(itemView: View) :
        ...
        private val movieRating: TextView = itemView.findViewById(R.id.textAvaliacao)
