...
class UpcomingMovieAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return MovieViewHolder(
            LayoutInflater.from(parent.context)
                .inflate(R.layout.recycler_view_upcoming_movie, parent, false),
            )
    }
    ...
    class MovieViewHolder(itemView: View) :
        ...
        private val movieDate: TextView = itemView.findViewById(R.id.textData)
        ...
        fun bind(movieList: Movie, listener: ((Movie) -> Unit)?) {
            ...
            movieDate.text = formatter.format(parser.parse(movieList.releaseDate)!!)
